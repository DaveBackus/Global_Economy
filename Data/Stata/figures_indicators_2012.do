...
twoway  (tsline gdp_gr ind_gr if tin(1960q1, 2012q2), lp(solid dash) lc(blue red))
...
twoway scatter ind_gr date if tin(1970m1, 2012m5), mstyle(none) connect(direct) lc(black)
...
local meanminus = `r(mean)'-`r(sd)';
local temp = m(1992m1); 
twoway scatter emp_gr date if tin(1970m1, 2012m5),
...
twoway scatter IC4WSA date if tin(1970m1, 2012m5),
	mstyle(none) connect(direct) lc(black)
	yline(`r(mean)', lc(black))
	yline(`meanplus', lc(black) lpattern(dash))
	yline(`meanminus', lc(black) lpattern(dash))
...
twoway scatter HOUST date if tin(1970m1, 2012m5),
	mstyle(none) connect(direct) lc(black)
	yline(`r(mean)', lc(black))
	yline(`meanplus', lc(black) lpattern(dash))
	yline(`meanminus', lc(black) lpattern(dash))
