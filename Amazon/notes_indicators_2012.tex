...
an indicator is leading or lagging, procyclical or countercyclical.
...
we rate each pro-cyclical indicator as strong positive if
...
For countercyclical indicators we reverse the direction:
strong positive means below the ``mean minus one standard deviation line.''
