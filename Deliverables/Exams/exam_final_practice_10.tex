...
(``core inflation elevated'') and output is at or above target
(``high level of resource utilization'').
Since output at or above target, inflation is the appropriate focus.
...
cross. Why? Because the sticky wages the give AS its slope
...
\part The comment about utilization tells you that output is currently
at or beyond the long-run supply curve AS$^*$.
...
\part What other factors would you consider in
...
\part To undo the increase in the monetary base, the PBC will issue 100 worth of bonds and accept money in return:
%
\begin{center}
\begin{tabular}{lrclr}
               Assets  &     &&     Liabilities                     \\
...
\part The PBC is now likely losing money on its portfolio
for two reasons:
...
to generate higher returns on assets.
...
\part Back to Bernanke:  How would you represent the impact of
