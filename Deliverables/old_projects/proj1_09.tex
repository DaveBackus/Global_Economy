...
\item Each final sale is allocated in the table 
...
\item Given the expenditure components, 
we compute (gross domestic) saving as 
\[
    S \;=\; Y - C - G \;=\; 82-65 - 2 = 15 .
\]

\item $S$ computed above equals $ I + \NX$.  As it must!  
...
\item Revenues are 2k, expenses are 3k, so the surplus is $ -1$k 
(a deficit).  
...
%***The rest of this I need to update.  
